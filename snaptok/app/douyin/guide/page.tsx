      ...
      <main className="flex-1 py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">{t(tr.guide_page.subtitle_douyin, lang)}</p>
          </div>
          ...
          <Card className="border-border bg-primary text-primary-foreground">
            <CardContent className="text-center p-8 md:p-12">
              ...
              <Button asChild size="lg" variant="secondary" className="font-semibold">
                <Link href="/douyin">{t(tr.guide_page.start, lang)}<ArrowRight className="ml-2 h-5 w-5" /></Link>
              </Button>
            </CardContent>
          </Card>
        </div>
