            ...
            <SheetContent side="right" className="w-[300px] sm:w-[350px]">
              <div className="flex flex-col gap-6 pt-6">
                ...
                <div className="flex items-center gap-1 rounded-full border border-border bg-muted p-1 text-sm w-fit">
                  <Link href="/" className="rounded-full px-4 py-1.5 font-medium text-muted-foreground" onClick={() => setIsOpen(false)}>🎵 TikTok</Link>
                  <span className="rounded-full px-4 py-1.5 font-medium bg-background text-foreground shadow-sm">🎬 Douyin</span>
                </div>
                  ...
                  {loggedIn ? (
                    ...
                    <>
                      ...
                      <Link href="/auth/register" onClick={() => setIsOpen(false)}>
                        <Button className="w-full bg-red-500 hover:bg-red-600">{lReg}</Button>
                      </Link>
                    </>
                  )}
                </div>
